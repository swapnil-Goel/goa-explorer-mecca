...
// ═══════════════════════════════════════
const LOCATIONS = [
  { id: 1,  name: "Arambol Beach",       x: 25.5, y: 14.5 },
  { id: 2,  name: "Mandrem Beach",       x: 26.5, y: 18.0 },
  { id: 3,  name: "Ashwem Beach",        x: 27.5, y: 21.5 },
  { id: 4,  name: "Morjim Beach",        x: 28.5, y: 25.0 },
  { id: 5,  name: "Vagator Beach",       x: 27.0, y: 30.0 },
  { id: 6,  name: "Anjuna Beach",        x: 25.0, y: 34.5 },
  { id: 7,  name: "Baga Beach",          x: 24.5, y: 38.0 },
  { id: 8,  name: "Calangute Beach",     x: 23.5, y: 41.5 },
  { id: 9,  name: "Candolim Beach",      x: 22.5, y: 45.0 },
  { id: 10, name: "Panjim",              x: 38.0, y: 40.5 },
  { id: 11, name: "Fontainhas",          x: 40.0, y: 43.0 },
  { id: 12, name: "Miramar Beach",       x: 25.5, y: 48.5 },
  { id: 13, name: "Dona Paula Beach",    x: 24.5, y: 52.0 },
  { id: 14, name: "Majorda Beach",       x: 24.0, y: 62.0 },
  { id: 15, name: "Colva Beach",         x: 22.5, y: 67.0 },
  { id: 16, name: "Varca Beach",         x: 24.5, y: 71.0 },
  { id: 17, name: "Benaulim Beach",      x: 23.0, y: 74.0 },
  { id: 18, name: "Cabo De Rama Fort",   x: 32.0, y: 81.0 },
  { id: 19, name: "Agonda Beach",        x: 24.5, y: 86.0 },
  { id: 20, name: "Palolem Beach",       x: 26.0, y: 92.0 },
  { id: 21, name: "Dudhsagar Waterfalls",x: 72.0, y: 57.0 },
  { id: 22, name: "Harvalem Waterfalls", x: 64.0, y: 22.0 },
  { id: 23, name: "Surla Waterfalls",    x: 70.0, y: 28.0 },
  { id: 24, name: "Chapora Fort",        x: 29.0, y: 27.5 },
];
