...
// ═══════════════════════════════════════
const LOCATIONS = [
  { id: 1,  name: "Arambol Beach",        x: 32.0, y: 11.0 },
  { id: 2,  name: "Mandrem Beach",        x: 34.0, y: 15.5 },
  { id: 3,  name: "Ashwem Beach",         x: 35.0, y: 19.0 },
  { id: 4,  name: "Morjim Beach",         x: 36.5, y: 23.0 },
  { id: 5,  name: "Vagator Beach",        x: 34.0, y: 28.5 },
  { id: 6,  name: "Anjuna Beach",         x: 31.5, y: 33.0 },
  { id: 7,  name: "Baga Beach",           x: 30.5, y: 37.0 },
  { id: 8,  name: "Calangute Beach",      x: 29.5, y: 40.5 },
  { id: 9,  name: "Candolim Beach",       x: 28.5, y: 44.0 },
  { id: 10, name: "Panjim",               x: 42.0, y: 38.5 },
  { id: 11, name: "Fontainhas",           x: 44.5, y: 40.5 },
  { id: 12, name: "Miramar Beach",        x: 31.0, y: 47.5 },
  { id: 13, name: "Dona Paula Beach",     x: 29.5, y: 51.0 },
  { id: 14, name: "Majorda Beach",        x: 30.0, y: 61.0 },
  { id: 15, name: "Colva Beach",          x: 28.5, y: 65.5 },
  { id: 16, name: "Varca Beach",          x: 29.5, y: 69.5 },
  { id: 17, name: "Benaulim Beach",       x: 28.5, y: 73.0 },
  { id: 18, name: "Cabo De Rama Fort",    x: 38.0, y: 80.5 },
  { id: 19, name: "Agonda Beach",         x: 31.0, y: 85.5 },
  { id: 20, name: "Palolem Beach",        x: 33.5, y: 91.5 },
  { id: 21, name: "Dudhsagar Waterfalls", x: 76.0, y: 54.0 },
  { id: 22, name: "Harvalem Waterfalls",  x: 67.5, y: 20.0 },
  { id: 23, name: "Surla Waterfalls",     x: 74.0, y: 26.0 },
  { id: 24, name: "Chapora Fort",         x: 36.0, y: 26.0 },
];
// ═══════════════════════════════════════
// COUPON GENERATION
// ═══════════════════════════════════════
